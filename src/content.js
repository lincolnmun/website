...
export const T = {
  en: {
    ...
    footer: {
      ...
      facts: [
        ...
        { label: 'Delegates',  value: 'Up to 100' },
      ],
      connect: 'Connect',
  ...
  es: {
    ...
    letter: {
      ...
      body: [
        'Es un enorme placer darles la más cálida bienvenida a la Asociación Escuelas Lincoln como Secretarios Generales de la Primera Edición de LINCOLNMUN, que se llevará a cabo del viernes 2 al domingo 4 de octubre de 2026.',
        ...
        'Hecho por estudiantes y para estudiantes, LINCOLNMUN ofrece numerosas oportunidades de liderazgo para jóvenes de toda la Argentina. Además de organizar las ceremonias, los estudiantes están a cargo de presidir los trece comités. La conferencia está abierta a todos, tengan experiencia previa o no. Los comités se dictan en inglés y en español, para que cada delegado pueda participar en el idioma con el que se sienta más cómodo.',
    ...
    footer: {
      ...
      facts: [
        ...
        { label: 'Delegados',  value: 'Hasta 100' },
      ],
      connect: 'Contacto',
