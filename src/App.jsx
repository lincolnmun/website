      ...
      <div className="grid grid-cols-1 md:grid-cols-2" style={{ maxWidth: 1100, margin: '0 auto', gap: '5rem', alignItems: 'start' }}>
        ...
        <Reveal>
          ...
          <motion.p variants={fadeUp} style={{ fontFamily: F.body, fontSize: '0.95rem', lineHeight: 1.85, color: '#334155', marginBottom: '1.35rem' }}>
            LINCOLNMUN is a student-run Model United Nations conference hosted at Asociación Escuelas Lincoln in Vicente López. It is open to secondary-school delegations from across Buenos Aires Province and the wider region. The first edition runs 2–4 October 2026; a second is planned for April 2027.
          </motion.p>
          <motion.p variants={fadeUp} style={{ fontFamily: F.body, fontSize: '0.95rem', lineHeight: 1.85, color: '#334155', marginBottom: '2.25rem' }}>
            It was started by students, for students — as the CAS project of the Founding Secretaries-General. The goal is straightforward: a well-run conference that Buenos Aires schools can count on coming back to.
          </motion.p>
